...
<div class="wrapper">
  ...
  <form action="/XShop/SignInAdmin" method="post">
      <div>
        ...
        <input class="user-input" type="text" name="userName" placeholder="Admin_User_Name" 
     ...
     <div>
      <input type="submit" value="Sign in" />
       ...
       <c:if test="${!empty requestScope.error}">
                   <c:set var="errormsg" value="${requestScope.error}"></c:set>
                   <div class="error-msg" style="text-align: center; color: #cd2a19; font-size: 15px;">
...
<!--A jsp file for the login view for the admin

on the sign in button calls the SIgnInAdminService servlet (url /"/SignInAdmin")

client-side validation for empty fields and invalid data

if request have error message .. change view accordingly and view error message-->